        ...
        <tr> 
            <td valign="top" class="main" style="font-family: arial">
                ...
                <div style="padding: 0px 50px 0px;">
                    <table width="100%">
                        <tr>
                            <td style="text-align:center"><h2>NILAI DOSEN PENGUJI</h2></td>
                        </tr> 
                    </table>
                    <hr>
                    <div>&nbsp;</div>
                                        ...
                                        @foreach ($penilaian as $k => $v)
                                            <tr>
                                                ...
                                                <th class="text-center" style="width:20%;padding:3px;;text-align:center"> 
                                                    : {{isset($score[$item->penguji_id][$v->id]) ? $score[$item->penguji_id][$v->id] : '___________'}}
                                                </th>
                                                ...
                                                <th class="text-center"style="width:20%;padding:3px;;text-align:center"> 
                                                    = {{isset($score[$item->penguji_id][$v->id]) ? ($score[$item->penguji_id][$v->id] * $v->bobot_penguji / 100) : '___________'}}
                                                </th>
                                                @php
                                                    if(isset($score[$item->penguji_id][$v->id]))
                                                    {
                                                        $total+=$score[$item->penguji_id][$v->id];
                                                    }
                                                    else
                                                        $total+=0;
                                                @endphp
