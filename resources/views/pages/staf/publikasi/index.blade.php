                                             ...
                                             <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu pull-right" role="menu">
                                                    <li>
                                                        ...
                                                        @if ($item->acc_dep==0)
                                                        <li>
                                                                <a href="javascript:verifikasi({{$item->id}},1,'dep')" title="Verifikasi Publikasi"><i class="fa fa-check"></i> Verifikasi Pimpinan Departemen</a>
                                                            </li>
                                                        @else
                                                            <li>
                                                                <a href="javascript:verifikasi({{$item->id}},0,'dep')" title="Verifikasi Publikasi"><i class="fa fa-ban"></i> Hapus Verifikasi Pimpinan</a>
                                                            </li>
                                                            @if ($item->acc_mandik==0)
                                                            <li>
                                                                    <a href="javascript:verifikasi({{$item->id}},1,'mandik')" title="Verifikasi Publikasi"><i class="fa fa-check"></i> Verifikasi Manajer Akademik</a>
                                                                </li>
                                                            @else
                                                                <li>
                                                                    <a href="javascript:verifikasi({{$item->id}},0,'mandik')" title="Verifikasi Publikasi"><i class="fa fa-ban"></i> Hapus Verifikasi Manajer Akademik</a>
                                                                </li>
                                                            @endif
                                                        @endif
...
<script>
    ...
    function verifikasi(id,status,pimpinan)
    {
        ...
        function(isConfirm) {
            if (isConfirm) {
                location.href='{{url("staf-publikasi-ilmiah-verifikasi")}}/'+id+'/'+status+'/'+pimpinan;
            } 
        });
    }
    function hapus(id)
    {
        ...
        function(isConfirm) {
            if (isConfirm) {
                location.href='{{url("staf-publikasi-ilmiah-hapus")}}/'+id;
            } 
        });
    }
    ...
    function detail(id)
    {
        $('#detail').load('{{url("/")}}/staf-publikasi-ilmiah-detail/'+id);
        $('#ajax-sm').modal('show');
    }
</script>
