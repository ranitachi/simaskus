    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <span>Jadwal {{ucwords($jenis)}}</span>
                </li>
            </ul>
                ...
                <div class="portlet box green">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase">Jadwal {{ucwords($jenis)}}</span>
                                        </div>
                                    </div>
                                    <div class="portlet-body">
                                        <div class="tools pull-left"> 
                                            <button type="button" onclick="lihatlaporan()" class="btn btn-md btn-primary pull-right"><i class="fa fa-search"></i> Lihat Jadwal</button>
