                                    ...
                                    @foreach ($penilaian as $k => $v)
                                        <tr>
                                            ...
                                            <th class="text-center" style="width:20%"> 
                                                <input type="number" min="0" max="100" name="nilai_angka[{{$v->c_id}}]" class="form-control input-circle" placeholder="" value="" id="nilai_angka_{{$k}}" onkeyup="hitung(this.value,{{$k}})" style="text-align:center;" onblur="cek(this.value,{{$k}})">
                                            </th>
                                            ...
                                            <th class="text-center"style="width:20%"> 
                                                <input type="number" min="0" max="100" id="total_{{$k}}" name="subtotal[{{$v->c_id}}]" class="form-control input-circle jlh" placeholder=""  readonly style="text-align:center;">
                                            </th>
                                        </tr>
                                    @endforeach
                                    <tr>
                                        ...
                                        {{-- </th> --}}
                                        <th style="text-align:right;">
                                            <input type="text" id="total" name="total" class="form-control input-circle" placeholder="" value="" readonly style="text-align:center;">
                                            <br>
                                            <input type="text" id="huruf" name="huruf" class="form-control input-circle" placeholder="" readonly style="text-align:center;">
                                        </th>
                                    </tr>
                                </tbody>
                            </table>
