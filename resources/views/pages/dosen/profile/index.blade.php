...
@section('title')
    <title>Profil dosen :: SIMASKUS</title>
@endsection
        ...
        <div class="col-md-12">
            ...
            <div class="profile-sidebar">
                ...
                <div class="profile-userpic">
                    <img src="{{asset('img/dosen.png')}}" class="img-responsive" alt=""> </div>
                <!-- END SIDEBAR USERPIC -->
                <!-- SIDEBAR USER TITLE -->
...
<!-- END MENU -->
            ...
            <div class="profile-content">
                        ...
                        <div class="portlet light ">
                            <div class="portlet-title tabbable-line">
                                <div class="caption caption-md">
                                    ...
                                    <span class="caption-subject font-blue-madison bold uppercase">Profil dosen</span>
                                </div>
                            ...
                            <div class="portlet-body">
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="tab_1_1">
                                        <form role="form" action="{{url('simpan-profil-dosen')}}" method="POST">
                                            {{ csrf_field() }}
                ...
                <div class="tab-pane" id="tab_1_3">
                    <form method="POST" action="{{ route('simpan.passworddosen') }}" id="simpan-password">
                        {{ csrf_field() }}
                        <div class="form-group">
