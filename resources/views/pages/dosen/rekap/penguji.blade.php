                            ...
                            <div style="background: #eee;">
                                <a class="dashboard-stat dashboard-stat-v2 green" href="#">
                                    ...
                                    <div class="details text-center">
                                        <div class="desc" style="padding-top:20px;">Jumlah Menguji</div>
                                        <div class="number text-center" style="font-size:23px;padding-top:0px;">S3 : <b>{{isset($rekap['S3']) ? count($rekap['S3']) : 0}} x</b></div>
                                    </div>
                                </a>
                                <a class="dashboard-stat dashboard-stat-v2 blue" href="#">
                                    ...
                                    <div class="details text-center">
                                        <div class="desc" style="padding-top:20px;">Jumlah Menguji</div>
                                        <div class="number text-center" style="font-size:23px;padding-top:0px;">S2 : <b>{{isset($rekap['S2']) ? count($rekap['S2']) : 0}} x</b></div>
                                    </div>
                                </a>
                                <a class="dashboard-stat dashboard-stat-v2 red" href="#">
                                    ...
                                    <div class="details text-center">
                                        <div class="desc" style="padding-top:20px;">Jumlah Menguji</div>
                                        <div class="number text-center" style="font-size:23px;padding-top:0px;">S1 : <b>{{isset($rekap['S1']) ? count($rekap['S1']) : 0}} x</b></div>
                                    </div>
                                </a>
