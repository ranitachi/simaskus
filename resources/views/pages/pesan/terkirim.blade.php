                                ...
                                <div class="col-md-10">
                                    <div class="inbox-body">
                                        <div class="inbox-header">
                                            <h1 class="pull-left">Pesan Terkirim</h1>
                                            ...
                                            <form id="hapus-pesan" action="{{ route('pesan.destroy') }}" method="POST">
                                                ...
                                                <table class="table table-striped table-bordered table-hover" id="sample_1">
                                                    ...
                                                    @foreach ($terkirim as $item)
                                                        <tr>
                                                            <td onclick="location.href='pesan/{{ $item->id }}'" class="text-center">{{ $no++ }}</td>
                                                            <td onclick="location.href='pesan/{{ $item->id }}'" class="text-center">{{ $item->untuk }}</td>
                                                            <td onclick="location.href='pesan/{{ $item->id }}'" class="text-center">{{ $item->judul }}</td>
                                                            ...
                                                            <td  onclick="location.href='pesan/{{ $item->id }}'"class="text-center">{{ tgl_indo_time2($item->created_at) }}</td>
