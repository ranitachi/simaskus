                                ...
                                <div class="col-md-10">
                                    <div class="inbox-body">
                                        <div class="inbox-header">
                                            <h1 class="pull-left">Balas Pesan</h1>
                                        ...
                                        <div class="inbox-content"> 
                                            <form class="inbox-compose form-horizontal" action="{{ route('pesan.store') }}" id="fileupload" action="#" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="controls controls-to">
                                                        ...
                                                        <select class="form-control select2" name="to[]" data-placeholder="Pilih Tujuan" multiple>
                                                            ...
                                                            @foreach ($user as $item)
                                                                ...
                                                                @if($item->kat_user==1)
                                                                    <option {{ $sel }} value="{{ $item->id }}__{{ $item->name }}">STAF :: {{ $item->name }} ( {{ $item->email }} )</option>
                                                                @elseif($item->kat_user==2)
                                                                    <option {{ $sel }} value="{{ $item->id }}__{{ $item->name }}">DOSEN :: {{ $item->name }} ( {{ $item->email }} )</option>
                                                                @elseif($item->kat_user==3)
                                                                    <option {{ $sel }} value="{{ $item->id }}__{{ $item->name }}">MAHASISWA :: {{ $item->name }} ( {{ $item->email }} )</option>
                                                                @endif
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="inbox-form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" class="form-control" name="subject" required value="Balas:{{ $get->judul }}"> </div>
                                                </div>
                                                <div class="inbox-form-group">
